...
class AppColors{
  ...
  static final Color mainColor = const Color(0xff087383);
  //static final Color mainColor = const Color(0xFFfa7552);
  static final Color iconColor1 = const Color(0xFFffd28d);
  static final Color iconColor2 = const Color(0xfff28482);
  ...
  static final Color yellowColor = const Color(0xfff8cdad);
}